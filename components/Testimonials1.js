...
const Testimonial = () => {
  return (
    <section
      className="relative isolate overflow-hidden bg-yellow-50 px-8 py-24 sm:py-32"
      id="testimonials"
    >
      ...
      <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-yellow-50 shadow-lg ring-1 ring-base-content/10 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
